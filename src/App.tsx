...
const App: React.FC = () => {
  ...
  // ── 1. Check Server Session Cookie (/api/me) on Mount ───────────────────────
  useEffect(() => {
    fetch('/api/me')
  ...
  // ── 1. STANDALONE LANDING PAGE (Hides internal Navbar when not signed in) ──
  if (showLanding) {
    return (
      <LandingPage
  ...
  // ── 2. FULL AI WORKSPACE (Gnosis AI / Yada Guide / Face Swap Studio) ────────
  return (
    <div className="flex flex-col h-screen w-screen bg-[#FDFBF7] text-slate-800 overflow-hidden font-sans">
      
      {/* Top Navbar with Gnosis AI & Yada Guide Switcher */}
      <Navbar
        tenants={tenants}
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        {/* View Switcher: Chat vs Library vs FaceSwapStudio */}
